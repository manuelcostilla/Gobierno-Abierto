          ...
          <div className="w-full">
            <div className="lg:flex lg:flex-col">
                <div className="mb-4">
                  ...
                  <Link href={data.pdfLink} className="block mx-auto lg:mx-0 mt-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 w-40 text-center rounded-medium text-base xs:text-xs transition duration-300 ease-in-out" >
                  {data.boton}
                  </Link>
                </div>
            </div>
