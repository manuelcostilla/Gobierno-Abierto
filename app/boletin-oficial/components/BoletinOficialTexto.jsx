...
export const BoletinOficialTexto = () => {
  return (
    <>
  <div className='flex h-36 w-screen bg-blue-header justify-center items-center'>
    <h1 className='text-4xl font-sans text-white font-bold'>BOLETIN OFICIAL</h1>
  </div>
  <div className='px-4 md:px-8'>
    <h2 className='w-full md:w-2/4 my-8 md:my-20 text-slate-700 text-center md:text-left'>
