  ...
  return (
    <>
      ...
      <div className="p-6 w-full flex  justify-center ">
        <div className="w-full lg:w-[700px] lg:ml-5 p-2 mb-2 flex flex-col ">
          ...
          {sections.intendencia && (
            <ul>
              ...
              <li>
                <h1 className="font-bold mt-2">ASESORES</h1>
                <p className="text-gray-700 mb-2">BOGADO FERNANDO | ASESOR</p>
              </li>
              <div className="border-solid border-b-2 border-b-gray-400">
              </div>
              <li>
                ...
                <li>
                  ...
                  <p className="text-gray-700 mb-2 ">DIEZ, FRANCISCO JOSE | Juez de Faltas</p>
                </li>
                <div className="border-solid border-b-2 border-b-gray-400">
                </div>
                <li>
                  <h1 className="font-bold mt-2 ml-8">DIRECCIÓN GENERAL DE COMUNICACIÓN Y MEDIOS</h1>
                  <p className="text-gray-700 mb-2 ">DEPAULI, LUCIANA | Directora General</p>
                </li>
                <div className="border-solid border-b-2 border-b-gray-400">
                </div>
                ...
                <p className="text-gray-700 mb-2">FRANZANTI, ANDRES | Director</p>
                {sections.coordinacion && (
                  <ul>
                    ...
                    <li>
                      ...
                      <p className="text-gray-700 mb-2 ml-8">GENOUD, JULIO RICARDO | Delegado</p>
                    </li>
                  </ul>
                )}
                <div className="border-solid border-b-2 border-b-gray-400">
                ...
                <p className="text-gray-700 mb-2">SAVARESI, AGOSTINA | Directora</p>
                {sections.genero && (
                  <ul>
                    <div className="border-solid border-b-2 border-b-gray-400">
                    </div>
          ...
          <ul>
            <li>
              ...
              >
                <BsArrowRightShort className="inline text-xl relative bottom-[1px]" /> SECRETARÍA GENERAL DE GOBIERNO
                <p className="text-black mb-2">
                  SILVANA NOEMI IOZZIA | Secretario
                </p>
              </h1>
              <div className="border-solid border-b-2 border-b-gray-400">
              </div>
          ...
          {sections.gobierno && (
            <ul>
              ...
              >
                <BsArrowRightShort className="text-blue-header inline text-xl relative bottom-[1px]" /> SUBSECRETARÍA DE PRODUCCION Y DESARROLLO ECONÓMICO
              </h1>
          ...
          <ul>
            <li>
              ...
              >
                <BsArrowRightShort className="text-blue-header inline text-xl relative bottom-[1px]" /> SECRETARÍA DE PLANIFICACIÓN Y GESTION PÚBLICA
                <p className="text-black mb-2">
          ...
          {sections.salud && (
            <ul>
              <li>
                <h1 className="text-black font-bold mt-2 ml-8">DIRECCIÓN GENERAL DE ATENCIÓN PRIMARIA Y PREVENCIÓN DE LA SALUD</h1>
                <p className="text-gray-700 mb-2 ml-8">ELMER, MARCELO ALEJANDRO | Director General</p>
              </li>
              <li>
                <h1 className="text-black font-bold mt-2 ml-8">DIRECCIÓN GENERAL ADMINISTRATIVA DEL HOSPITAL MUNICIPAL</h1>
                <p className="text-gray-700 mb-2 ml-8">LENGUITTI, JULIO MANUEL | Director General</p>
              </li>
              <li>
                <h1 className="text-black font-bold mt-2 ml-8">DIRECCIÓN GENERAL MÉDICA DEL HOSPITAL MUNICIPAL</h1>
                <p className="text-gray-700 mb-2 ml-8">CENTURION, DIEGO | Director General</p>
              </li>
              <li>
                <h1 className="text-black font-bold mt-2 ml-8">DPTO DE ENFERMERÍA</h1>
