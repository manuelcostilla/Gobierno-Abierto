      ...
      <div className="max-w-5xl mx-auto mb-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 bg-white/90 backdrop-blur-xl border border-neutral-100 p-5 rounded-3xl shadow-lg">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-lg font-black text-blue-title tracking-tight uppercase">Licitaciones Privadas</h2>
              <p className="text-neutral-500 text-xs font-medium">Contrataciones por invitación</p>
            </div>
          </div>
                    ...
                    <div className="max-h-[350px] w-full p-6 overflow-y-auto overflow-x-hidden">
                      <div className="space-y-3">
                        ...
                        <p className="mb-4 font-black text-blue-GobAb uppercase text-xs tracking-wider">
                          Detalles de la Licitación Privada
                        </p>
                      ...
                      <div className="flex flex-wrap justify-center gap-4 mt-6 pt-5 border-t border-slate-100">
                        ...
                        <Button
                          ...
                          className="bg-neutral-700 hover:bg-neutral-800 text-white rounded-full px-6 h-10 shadow-md transition-all hover:-translate-y-0.5"
                        >
                        ...
                        <Button
                          ...
                          className="bg-neutral-900 hover:bg-black text-white rounded-full px-6 h-10 shadow-md transition-all hover:-translate-y-0.5"
                        >
