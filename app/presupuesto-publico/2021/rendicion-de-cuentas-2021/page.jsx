...
function rendicionDeCuentas2021 () {
  return (
    <>
      <BannerText titulo="rendición de cuentas presupuesto PÚBLICO 2021" />
            ...
            <ArchivosDelPresupuestoButtons
              archivosData={
                archivosDelPresupuestoPdf[1]
                  .estadodeEjecucionporFinalidadyFuncion[0].ejecucion2021
              }
            />
          </TabsContent>
        </Tabs>
...
export default rendicionDeCuentas2021
