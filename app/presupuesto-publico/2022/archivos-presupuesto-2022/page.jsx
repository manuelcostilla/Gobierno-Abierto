...
function archivosDelPresupuesto () {
  return (
    <>
      <BannerText titulo="Archivos del Presupuesto PÚBLICO 2022" />
      <div className="container mx-auto mt-10 mb-10">
        ...
        <ArchivosDelPresupuestoButtons archivosData={archivosDelPresupuestoPdf[0].archivosDelPresupuestoPorAño[0].archivos2022}/>
      </div>
    </>
  )
}
