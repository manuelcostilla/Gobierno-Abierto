...
function rendicionDeCuentas2022 () {
  return (
    <>
      <BannerText titulo="rendición de cuentas presupuesto PÚBLICO 2022" />
            ...
            <ArchivosDelPresupuestoButtons
              archivosData={
                archivosDelPresupuestoPdf[1]
                  .estadodeEjecucionporFinalidadyFuncion[0].ejecucion2022
              }
            />
          </TabsContent>
        </Tabs>
...
export default rendicionDeCuentas2022
