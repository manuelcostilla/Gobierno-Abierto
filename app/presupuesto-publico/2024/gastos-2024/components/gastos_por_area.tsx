      ...
      {chart
        ...
        <div className="grid gap-4 md:grid-cols-7">
          <Card className="col-span-4">
            <CardHeader>
              <CardTitle>Gráfico de gastos por área del ejecutivo 2024</CardTitle>
              <CardDescription>
              Gastos organizados por área del ejecutivo año 2024
              </CardDescription>
            </CardHeader>
        ...
        <div className="grid gap-4 md:grid-cols-7">
          <Card className="col-span-4">
            <CardHeader>
              <CardTitle>
                Gráfico de gastos por área del ejecutivo 2024
              </CardTitle>
              <CardDescription>
                Gastos organizados por área del ejecutivo año 2024
              </CardDescription>
