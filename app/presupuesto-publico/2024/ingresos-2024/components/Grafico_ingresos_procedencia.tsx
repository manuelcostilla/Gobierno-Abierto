...
export function GraficosIngresosProcedencia2024 ({ chart, setChart }) {
  return (
    <div>
      {chart
        ? (
        <>
          <div className="grid gap-4 md:grid-cols-7">
            <Card className="col-span-4">
              <CardHeader>
                <CardTitle>Gráfico ingresos por procedencia 2024</CardTitle>
                <CardDescription>
                  Resumen de los ingresos del 2024 por procedencia
                </CardDescription>
              </CardHeader>
