...
const chartData = [
  ...
  },
  {
    ...
    valor$: 1000000.00,
    fill: "var(--color-ventabienesservicios)",
  },
]
...
const chartConfig = {
  ...
  ventabienesservicios: {
    label: "Venta de bienes y servicios - 8",
    color: "#91eabc"
  }
...
export function GraficosIngresos2026({ chart, setChart }) {
  return (
    <div>
      {chart
        ? (
          <>
            <div className="grid gap-4 md:grid-cols-7">
              <Card className="col-span-4">
                <CardHeader>
                  <CardTitle>Gráfico ingresos por origen 2026</CardTitle>
                  <CardDescription>
                    Resumen de los ingresos del 2026 por origen
                  </CardDescription>
                </CardHeader>
