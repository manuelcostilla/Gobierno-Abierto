...
export function GraficosIngresosProcedencia2026({ chart, setChart }) {
  return (
    <div>
      {chart
        ? (
          <>
            <div className="grid gap-4 md:grid-cols-7">
              <Card className="col-span-4">
                <CardHeader>
                  <CardTitle>Gráfico ingresos por procedencia 2026</CardTitle>
                  <CardDescription>
                    Resumen de los ingresos del 2026 por procedencia
                  </CardDescription>
                </CardHeader>
