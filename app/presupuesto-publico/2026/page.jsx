...
export default function PresupuestoPublico2026() {
  return (
    <>
      <BannerText titulo="Ingresos y gastos 2026" />
        ...
        <div className="flex flex-wrap justify-center items-center container pb-20 pt-20 ">
          <div className="m-5">
            <SectionCard
              ...
              link="./2026/archivos-presupuesto-2026"
            />
          </div>
          <div className="m-5">
            <SectionCard
              titulo="Ingresos 2026"
              textlink="Ver más información"
              link="./2026/ingresos-2026"
            />
          </div>
          <div className="m-5">
            <SectionCard
              titulo="Gastos 2026"
              textlink="Ver más información"
              link="./2026/gastos-2026"
            />
          </div>
          <div className="m-5">
            <SectionCard
              titulo="Rendición de cuentas 2026"
              textlink="Ver más información"
