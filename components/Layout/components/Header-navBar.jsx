...
export const HeadernavBar = () => {
  ...
  return (
    ...
    <nav className={`lg:flex lg:justify-evenly lg:items-center ${isNavOpen ? 'block' : 'hidden'} lg:w-full lg:h-[60px] bg-gray-nav lg:border-b-4 lg:border-b-green-nav w-full h-auto font-sans`}>
