...
export const Main = () => {
  return (
    <>
        ...
        <div className="lg:grid lg:w-[50%] lg:justify-center lg:mb-[100px] lg:mt-[100px] lg:m-auto lg:gap-[5rem] lg:grid-cols-main lg:grid-rows-main-row grid grid-cols-1 w-full">
